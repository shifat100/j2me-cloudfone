...
function setListeners() {
    ...
    function handleKeyEvent(e) {
        ...
        if (!isDown && (e.key === 'Escape' || e.keyCode === 27)) {


            keyRepeatManager.post(true, 'KeyQ', {
                symbol: 'q'.charCodeAt(0),
                ctrlKey: false,
                shiftKey: false
            });

            keyRepeatManager.post(false, 'KeyQ', {
                symbol: 'q'.charCodeAt(0),
                ctrlKey: false,
                shiftKey: false
            });
    ...
    window.addEventListener('back', function (event) {
        ...
        keyRepeatManager.post(true, 'KeyW', {
            symbol: 'w'.charCodeAt(0),
            ctrlKey: false,
            shiftKey: false
        });

        keyRepeatManager.post(false, 'KeyW', {
            symbol: 'w'.charCodeAt(0),
            ctrlKey: false,
            shiftKey: false
        });
